...
.card {border:unset; box-shadow:0px 0px 5px #00000022;}
.card-header {border:unset;}

.modal-content {border: unset; box-shadow:0px 0px 5px #00000022;}
.modal-header {border: unset; background:var(--bs-light);}
.modal-footer {border: unset; background:var(--bs-light);}

.input-group-text, .form-control {border:solid 1px #eee !important;}
