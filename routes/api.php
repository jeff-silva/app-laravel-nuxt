...
Route::post('pages/delete', 'App\Http\Controllers\PagesController@delete');
...
Route::post('users/delete', 'App\Http\Controllers\UsersController@delete');
...
Route::post('files/delete', 'App\Http\Controllers\FilesController@delete');
